...
while movement_number>0:
    while movement_number>0 and left_change(mat) != mat:
        inp = input().split()
        used_inputs+=1
        k = int(inp[0])
        d = int(inp[1])
        movement+='L'
        mat = count_zero_left(left_change(mat),k,d)
        movement_number-=1
    while movement_number>0 and down_change(mat) != mat:
        inp = input().split()
        used_inputs+=1
        k = int(inp[0])
        d = int(inp[1])
        movement+='D'
        mat = count_zero_down(down_change(mat),k,d)
        movement_number-=1
    while movement_number>0 and right_change(mat) != mat:
        inp = input().split()
        used_inputs+=1
        k = int(inp[0])
        d = int(inp[1])
        movement+='R'
        mat = count_zero_right(right_change(mat),k,d)
        movement_number-=1
    while movement_number>0 and up_change(mat) != mat:
        inp = input().split()
        used_inputs+=1
        k = int(inp[0])
        d = int(inp[1])
        movement+='U'
        mat = count_zero_up(up_change(mat),k,d)
        movement_number-=1
#*****************************************************
score=0
for i in mat:
...
#*******************************************************
number_of_inputs = movement_number
for nn in range(number_of_inputs-used_inputs):
    input()
...
for m in mat:
    for n in m:
        print(n, end = '\t')
    print()
if (down_change(mat)==mat) and (up_change(mat)==mat) and (left_change(mat)==mat) and (right_change(mat)==mat):
