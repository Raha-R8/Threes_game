...
def biggest_change_down(mat,n1=n):
    ...
    if mat3!=left_change(mat3):
        ...
        if len(ls)>0:
            ...
            dc['D'] = 0
    return dc
#print(biggest_change_down(mat_input))
def find_best_move(mat):
    ...
    if len(final_answer_dict)>0:
        ...
        return best_move
    return 0
#it returns zero if there is no movement that would make a change in our matrice
#print(find_best_move(mat_input))
#now that we have the best move we can simply apply it to our matrice
